...
-- Nome do aluno:  Lucia Helena ferreira de Sousa Gomes
...
SELECT 
    ...
    D.PrazoEntrega AS 'Prazo de Entrega',
    V.NomeVendedor AS 'Nome do Vendedor'
FROM 
    CLIENTES C
JOIN 
    PEDIDOS D ON C.CodigoCliente = D.CodigoCliente
JOIN 
    ITEM_DE_PEDIDO I ON D.NumeroPedido = I.NumeroPedido
JOIN 
    PRODUTOS P ON I.CodigoProduto = P.CodigoProduto
JOIN 
    VENDEDORES V ON D.CodigoVendedor = V.CodigoVendedor
ORDER BY 
    C.NomeCliente, 
    P.DescricaoProduto, 
    I.Quantidade, 
